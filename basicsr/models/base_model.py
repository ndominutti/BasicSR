...
class BaseModel():
    ...
    def validation(self, dataloader, current_iter, tb_logger, save_img=False, idx_imgs_to_save=False):
        """Validation function.
        ...
        """
        if self.opt['dist']:
            self.dist_validation(dataloader, current_iter, tb_logger, save_img, idx_imgs_to_save)
        else:
